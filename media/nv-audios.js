...
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'Calzones.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (chat.audios && m.text.match(/(Kawai|kawai|adorable|Adorable)/gi)) {    
let vn = './media/kawai.m4a'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'kawai.m4a', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(oremos hermanos|Oremos hermanos|laoracion|La biblia|La oración|La biblia|La oración|la biblia|La Biblia)/gi)) {    
...
if (chat.audios && m.text.match(/(Miedo|miedo|Temor|temor|horror|Horror|tenme miedo|Tenme miedo)/gi)) {    
...
if (chat.audios && m.text.match(/(Nico nico|nico nico|Niko Niko|Niko niko|niko niko|nico|niko|Niko|nico|Nico)/gi)) {    
...
if (chat.audios && m.text.match(/(Norteños|norteños|Primos|Primas|primo|prima|Primo|Prima|primos|primas|hermanastro|hermanastra|Hermanastro|Hermanastra)/gi)) {    
...
if (chat.audios && m.text.match(/(Pajero|pajero)/gi)) {    
